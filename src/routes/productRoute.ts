...
ProductController.addProduct).get(ProductController.getAllProducts)
...
.patch(AuthMiddleware.isAuthenticated,AuthMiddleware.restrictTo(Role.Admin),ProductController.updatePrduct)
